...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<ErrorResponse> handleValidation(MethodArgumentNotValidException ex, HttpServletRequest request) {
        ...
        log.warn("Validation failed for {}: {}", request.getRequestURI(), errors.keySet());
    ...
    ResponseEntity<ErrorResponse> handleConflict(RuntimeException ex, HttpServletRequest request) {
        log.info("Request conflict at {}: {}", request.getRequestURI(), ex.getMessage());
    ...
    ResponseEntity<ErrorResponse> handleUnexpected(Exception ex, HttpServletRequest request) {
        log.error("Unhandled error processing {}", request.getRequestURI(), ex);
